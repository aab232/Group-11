...
--
-- Host: 127.0.0.1    Database: global-population-clock
-- ------------------------------------------------------
...
--
-- Current Database: `global-population-clock`
--

/*!40000 DROP DATABASE IF EXISTS `global-population-clock`*/;

CREATE DATABASE `global-population-clock` DEFAULT CHARACTER SET utf8mb4;

USE `global-population-clock`;
...
--
-- Dumping events for database 'global-population-clock'
--

--
-- Dumping routines for database 'global-population-clock'
--
